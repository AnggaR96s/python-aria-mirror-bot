...
- Clone this repo:
```
git clone https://github.com/AnggaR96s/python-aria-mirror-bot mirror-bot/
cd mirror-bot
```
...
```
- Add database - [check here](https://github.com/AnggaR96s/python-aria-mirror-bot#adding-database) (only if you are deploying it for the 1st time)
